...
export const HeroSection = () => {
  ...
  return <div id='hero' className='py-28 md:py-48 lg:py-60 relative z-0'>
    
    <div><BackgroundBeams className='-z-30'/></div>
      ...
      <div className='flex flex-col items-center'>
        <Image src={memojiImage} className='size-[100px]' alt='Person'/>
          <div className='bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex flex-container gap-4 rounded-lg items-center'>
            <div className='bg-green-500 size-2.5 relative rounded-full'><div className='bg-green-500 absolute animate-ping inset-0 rounded-full'></div></div>
            <div className='text-sm font-medium'>Available for new projects</div>
          </div>
          <div className='max-w-lg mx-auto'>
            <h1 className='md:text-5xl font-serif text-3xl text-center mt-8 tracking-wide'>Building 
            <FlipWords words={words} className='text-emerald-400'/> <br />
              
               User Experiences</h1>
               <h1 className='text-center text-3xl my-4'>I am <span className='text-emerald-400 font-serif'>Abhishek</span></h1>
